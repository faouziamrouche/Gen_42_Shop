...
<div {if isset($id) && $id} id="{$id}"{/if} class="product_list {if isset($leo_page) && $leo_page=='category'}{$LISTING_GRID_MODE}{/if} {if isset($productClassWidget)} {$productClassWidget}{/if}">
    <div class="row">
