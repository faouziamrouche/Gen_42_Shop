...
>
	...
	<span class="leo-quickview-bt-content">
		...
		<span class="hidden-md-down">{l s='Quick View' d='Shop.Theme.Global'}</span>
	</span>
</a>
</div>
...
{/block}<div class="action">
<!-- @file modules\appagebuilder\views\templates\front\products\file_tpl -->
{hook h='displayLeoCartButton' product=$product}
<div class="view">
	<a class="btn-product btn" href="{$product.url}">
		<span>{l s='More' d='Shop.Theme.Global'}</span>
	</a>
</div></div></div>
  </div>
</article>
