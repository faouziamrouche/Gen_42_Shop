	...
	<section id="main">
		<div id="mywishlist">
					  ...
					  <tbody>
						{if $wishlists}
							{foreach from=$wishlists item=wishlists_item name=for_wishlists}
								<tr>					 
									<td><a href="#" class="view-wishlist-product" data-name-wishlist="{$wishlists_item.name}" data-id-wishlist="{$wishlists_item.id_wishlist}"><i class="material-icons">&#xE8EF;</i>{$wishlists_item.name}</a><div class="leo-view-wishlist-product-loading leo-view-wishlist-product-loading-{$wishlists_item.id_wishlist} cssload-speeding-wheel"></div></td>
									...
									<td><a class="delete-wishlist" data-id-wishlist="{$wishlists_item.id_wishlist}" href="#" title="{l s='Delete' mod='leofeature'}"><i class="material-icons">&#xE872;</i></a></td>
								</tr>
							{/foreach}
						{/if}
					  </tbody>
			...
			<div class="send-wishlist">
				<a class="leo-send-wishlist-button btn btn-info" href="#" title="{l s='Send this wishlist' mod='leofeature'}">
