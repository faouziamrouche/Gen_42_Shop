        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'name' => 'css',
                    'desc' => sprintf($this->l('Please set write Permission for folder %s'), $this->position_css_folder) . ApPageSetting::freeTextDes(),
                    'readonly' => 'readonly',
                    'disabled' => 'disabled',
                ),
                array(
                    ...
                    'name' => 'js',
                    'desc' => sprintf($this->l('Please set write Permission for folder %s'), $this->position_js_folder) . ApPageSetting::freeTextDes(),
                    'readonly' => 'readonly',
                    'disabled' => 'disabled',
                )
            ),
