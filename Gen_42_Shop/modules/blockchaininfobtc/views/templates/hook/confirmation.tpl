...
<p>
	...
	<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='blockchaininfobtc'} <a href="{$link->getPageLink('contact', true)}">{l s='expert customer support team.' mod='blockchaininfobtc'}</a>
</p>
{else}
...
<p>
	...
	<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='blockchaininfobtc'} <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team.' mod='blockchaininfobtc'}</a>
</p>
{/if}
<hr />
