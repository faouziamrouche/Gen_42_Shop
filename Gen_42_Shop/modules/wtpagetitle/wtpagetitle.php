...
class WtPagetitle extends Module implements WidgetInterface
{
	...
	public function getWidgetVariables($hookName = null, array $configuration = [])
    {
		...
		else if (Tools::getIsset('id_product') && $page == 'product')
		{
			...
			$page_title = $this->getTranslator()->trans('Authentication', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'my-account')
			$page_title = $this->getTranslator()->trans('My account', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'order')
			$page_title = $this->getTranslator()->trans('Shopping-cart summary', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'order-opc')
			$page_title = $this->getTranslator()->trans('Shopping-cart summary', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'cart')
			$page_title = $this->getTranslator()->trans('Shopping-cart summary', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'address')
			$page_title = $this->getTranslator()->trans('Your addresses', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'addresses')
			$page_title = $this->getTranslator()->trans('Your addresses', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'manufacturer')
			$page_title = $this->getTranslator()->trans('Manufacturer', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'module-cheque-payment')
			$page_title = $this->getTranslator()->trans('Order summary', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'order-confirmation')
			$page_title = $this->getTranslator()->trans('Order confirmation', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'history')
			$page_title = $this->getTranslator()->trans('Order history', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'order-slip')
			$page_title = $this->getTranslator()->trans('Credit slips', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'identity')
			$page_title = $this->getTranslator()->trans('Your personal information', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'contact')
			$page_title = $this->getTranslator()->trans('Customer service - Contact us', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'prices-drop')
			$page_title = $this->getTranslator()->trans('Price drop', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'new-products')
			$page_title = $this->getTranslator()->trans('New products', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'best-sales')
			$page_title = $this->getTranslator()->trans('Top sellers', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'stores')
			$page_title = $this->getTranslator()->trans('Our stores', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'cms')
			$page_title = $this->getTranslator()->trans('About us', array(), 'Modules.WTPageTitle.Admin');
		else if ($page == 'sitemap')
			$page_title = $this->getTranslator()->trans('Sitemap', array(), 'Modules.WTPageTitle.Admin');
			...
			$page_title = $this->getTranslator()->trans('Search', array(), 'Modules.WTPageTitle.Admin');
