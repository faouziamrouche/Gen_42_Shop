...
//		$tree = $obj->getTree();	# validate module
        ...
        $html = '
					...
					';
        return LeoBlogHelper::freeText().$html.parent::renderForm();
    }
    ...
    public function renderList()
    {
        ...
        return LeoBlogHelper::freeText().parent::renderList();
    }
...
//				@unlink($tmp_name);
    ...
    {
        if (!$id_leoblog_blog = (int)Tools::getValue('id_leoblog_blog')) {
            $number_blog = (LeoBlogBlog::countBlogs(  Tools::getValue('id_leoblogcat') ));
            if($number_blog >= LeoBlogHelper::FREE_LIMIT_BLOG){
                $this->errors['number_blog'] = LeoBlogHelper::freeBlog();
            }
        }
