...
class LeoBlogHelper
{
    ...
    {
        //LeoBlogHelper::freeText();
        return '<div class="alert alert-warning ap-free-warning"><marquee direction="right" behavior="alternate">You are using free version of LeoBlog. '
    ...
    const FREE_LIMIT_BLOG = 4;
    public static function freeBlog()
    {
        return 'We are sorry that you are using free version module. You cannot add more blog in this category. Limit is ' . LeoBlogHelper::FREE_LIMIT_BLOG;
    }
    
    const FREE_LIMIT_CATEGORY = 4;
    public static function freeCategory()
    {
        return 'We are sorry that you are using free version module. You cannot add more category. Limit is ' . LeoBlogHelper::FREE_LIMIT_CATEGORY;
    }
}
